...
const Experience = () => (
  <section className="py-16 animate__animated animate__fadeInUp animate__delay-1s" id="experience">
    <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-8 animate__animated animate__slideInDown animate__delay-1s">
      Work Experiences:
    </h2>
    {experiences.map((exp, index) => (
      <div
        key={index}
        className="bg-white dark:bg-gray-800 rounded-xl shadow p-6 border border-gray-100 dark:border-gray-700 mt-6 animate__animated animate__slideInUp animate__delay-3s transform hover:scale-105 transition-transform duration-300 hover:shadow-xl"
      ...
      >
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h3 className="font-semibold text-lg text-gray-900 dark:text-white animate__animated animate__fadeInLeft" style={{ animationDelay: `${3.7 + index * 0.3}s` }}>
                {exp.position}
              </h3>
              ...
              <ul className="list-disc list-inside text-sm text-gray-700 dark:text-gray-300 space-y-1 animate__animated animate__fadeInUp" style={{ animationDelay: `${4.1 + index * 0.3}s` }}>
        ...
        <div className="flex flex-wrap gap-2 mt-4 animate__animated animate__fadeInUp" style={{ animationDelay: `${4.7 + index * 0.3}s` }}>
          {exp.technologies.map((tech, i) => (
            <span
              key={i}
              className="bg-gray-100 dark:bg-gray-700 text-sm px-3 py-1 rounded-full text-gray-800 dark:text-gray-200 animate__animated animate__bounceIn transform hover:scale-110 transition-transform duration-200"
